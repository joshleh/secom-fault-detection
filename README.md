...
[CI](https://github.com/joshleh/secom-fault-detection/actions/workflows/ci.yml)
[Python 3.11 | 3.12](#dependencies)
[License: MIT](LICENSE)
...
`docker build .` works on a fresh clone with no training required. The image is
...
- Emits **structured key-value logs** in the format
...
limitations, ethical considerations, and reproduction steps, see `[MODEL_CARD.md](MODEL_CARD.md)`.
